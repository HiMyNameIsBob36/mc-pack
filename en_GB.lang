resourcePack.subpackResolution=It Contains: %s
...
potion.absorption=§aAbsorption§7
potion.nightVision=§aNight Vision§7
potion.invisibility=§aInvisibility§7
potion.jump=§aJump Boost§7
potion.fireResistance=§aFire Resistance§7
potion.moveSpeed=§aSpeed§7
potion.waterBreathing=§aWater Breathing§7
potion.heal=§aInstant Health§7
potion.regeneration=§aRegeneration§7
potion.damageBoost=§aStrength§7
potion.slowFalling=§aSlow Falling§7
potion.turtleMaster2=§aResistance§7
potion.conduitPower=§aConduit Power§7
potion.digSpeed=§aHaste§7
potion.healthBoost=§aHealth Boost§7
potion.resistance=§aResistance§7
potion.saturation=§aSaturation§7
effect.villageHero=§aHero of the Village§7

potion.blindness=§cBlindness§7
potion.turtleMaster=§cSlowness§7
potion.confusion=§cNausea§7
potion.digSlowDown=§cMining Fatigue§7
potion.harm=§cInstant Damage§7
potion.hunger=§cHunger§7
potion.moveSlowdown=§cSlowness§7
potion.levitation=§cLevitation§7
potion.poison=§cPoison§7
potion.weakness=§cWeakness§7
potion.wither=§cWither§7
potion.windCharged=§cWind Charged§7
potion.oozing=§cOozing§7
potion.infested=§cInfested§7
potion.weaving=§cWeaving§7
effect.infested=§cInfested§7
effect.oozing=§cOozing§7
effect.darkness=§cDarkness§7
effect.weaving=§cWeaving§7
effect.wind_charged=§cWind Charged§7
effect.badOmen=§cBad Omen§7
...
## Food
item.apple.name=Apple 2 1.2 1.6s
item.baked_potato.name=Jacket Potato 2.5 3 1.6s
item.beetroot.name=Beetroot 0.5 0.6 1.6s
item.beetroot_soup.name=Beetroot Soup 3 3.6 1.6s
item.bread.name=Bread 2.5 3 1.6s
item.cake.name=Cake 7 1.4 0s
item.carrot.name=Carrot 1.5 1.8 1.6s
item.chorus_fruit.name=Chorus Fruit 2 1.2 1.6s
item.cooked_beef.name=Cooked Beef 4 6.4 1.6s
item.cooked_chicken.name=Cooked Chicken 3 3.6 1.6s
item.cooked_fish.name=Cooked Cod 2.5 3 1.6s
item.muttonCooked.name=Cooked Mutton 3 4.8 1.6s
item.cooked_porkchop.name=Cooked Porkchop 4 6.4 1.6s
item.cooked_rabbit.name=Cooked Rabbit 2.5 3 1.6s
item.cooked_salmon.name=Cooked Salmon 3 4.8 1.6s
item.cookie.name=Biscuit 1 0.2 1.6s
item.dried_kelp.name=Dried Kelp 0.5 0.1 0.8s 
item.appleEnchanted.name=Enchanted Apple 2 4.8 1.6s
item.golden_apple.name=Golden Apple 2 4.8 1.6s
item.golden_carrot.name=Golden Carrot 3 7.2 1.6s
item.honey_bottle.name=Honey Bottle 3 0.6 2s
item.melon.name=Melon 1 0.6 1.6s
item.mushroom_stew.name=Mushroom Stew 3 3.6 1.6s
item.poisonous_potato.name=Poisonous Potato 1 0.6 1.6s 
item.potato.name=Potato 0.5 0.3 1.6s
item.pufferfish.name=Pufferfish 0.5 0.1 1.6s 
item.pumpkin_pie.name=Pumpkin Pie 4 2.4 1.6s
item.rabbit_stew.name=Rabbit Stew 5 6 1.6s
item.beef.name=Raw Beef 1.5 0.9 1.6s
item.chicken.name=Raw Chicken 1 0.6 1.6s 
item.fish.name=Raw Cod 1 0.2 1.6s
item.muttonRaw.name=Raw Mutton 1 0.6 1.6s
item.porkchop.name=Raw Porkchop 1.5 0.9 1.6s
item.rabbit.name=Raw Rabbit 1.5 0.9 1.6s
item.salmon.name=Raw Salmon 1 0.2 1.6s
item.rotten_flesh.name=Rotten Flesh 2 0.4 1.6s 
item.spider_eye.name=Spider Eye 1 1.6 1.6s 
item.suspicious_stew.name=Suspicious Stew 3 ? 1.6s
item.sweet_berries.name=Sweet Berries 1 0.6 1.6s
item.clownfish.name=Tropical Fish 0.5 0.1 1.6s
item.glow_berries.name=Glow Berries 1 0.2 1.6s 14

## Animal Armour
item.copper_horse_armor.name=Copper Horse Armour 2
item.wolf_armor.name=Wolf Armour 5.5
item.horsearmordiamond.name=Diamond Horse Armour 5.5
item.horsearmorgold.name=Gold Horse Armour 3.5
item.horsearmoriron.name=Iron Horse Armour 2.5
item.horsearmorleather.name=Leather Horse Armour 1.5

## Armor
item.leather_helmet.name=Leather Cap 0.5 55
item.chainmail_helmet.name=Chain Helmet 1 165
item.iron_helmet.name=Iron Helmet 1 165
item.golden_helmet.name=Golden Helmet 1 77
item.diamond_helmet.name=Diamond Helmet 1.5 363
item.netherite_helmet.name=Netherite Helmet 1.5 407
item.turtle_helmet.name=Turtle Shell 1 275
item.copper_helmet.name=Copper Helmet 1 122
 
item.leather_chestplate.name=Leather Tunic 1.5 80
item.chainmail_chestplate.name=Chain Chestplate 2.5 240
item.iron_chestplate.name=Iron Chestplate 3 240
item.golden_chestplate.name=Golden Chestplate 2.5 112
item.diamond_chestplate.name=Diamond Chestplate 4 528
item.netherite_chestplate.name=Netherite Chestplate 4 592
item.copper_chestplate.name=Copper Chestplate 2 177
 
item.leather_leggings.name=Leather Pants 1 75
item.chainmail_leggings.name=Chain Leggings 2 225
item.iron_leggings.name=Iron Leggings 2.5 225
item.golden_leggings.name=Golden Leggings 1.5 105
item.diamond_leggings.name=Diamond Leggings 3 495
item.netherite_leggings.name=Netherite Leggings 3 555
item.copper_leggings.name=Copper Leggings 1.5 166
 
item.leather_boots.name=Leather Boots 1.5 65
item.chainmail_boots.name=Chain Boots 1.5 195
item.iron_boots.name=Iron Boots 1.5 195
item.golden_boots.name=Golden Boots 1.5 91
item.diamond_boots.name=Diamond Boots 1.5 429
item.netherite_boots.name=Netherite Boots 1.5 481
item.copper_boots.name=Copper Boots 0.5 144

## Tools
item.diamond_sword.name=Diamond Sword +7 1561
item.diamond_pickaxe.name=Diamond Pickaxe +5 1561 
item.diamond_axe.name=Diamond Axe +6 1561
item.diamond_shovel.name=Diamond Shovel +4 1561
item.diamond_hoe.name=Diamond Hoe +5 1561

item.golden_sword.name=Golden Sword +4 32
item.golden_pickaxe.name=Golden Pickaxe +2 32
item.golden_axe.name=Golden Axe +3 32
item.golden_shovel.name=Golden Shovel +1 32
item.golden_hoe.name=Golden Hoe +2 32

item.iron_sword.name=Iron Sword +6 250
item.iron_pickaxe.name=Iron Pickaxe +4 250
item.iron_axe.name=Iron Axe +5 250
item.iron_shovel.name=Iron Shovel +3 250
item.iron_hoe.name=Iron Hoe +4 250

item.stone_sword.name=Stone Sword +5 131
item.stone_pickaxe.name=Stone Pickaxe +3 131
item.stone_axe.name=Stone Axe +4 131
item.stone_shovel.name=Stone Shovel +2 131
item.stone_hoe.name=Stone Hoe +3 131

item.wooden_sword.name=Wooden Sword +4 59
item.wooden_pickaxe.name=Wooden Pickaxe +2 59
item.wooden_axe.name=Wooden Axe +3 59
item.wooden_shovel.name=Wooden Shovel +1 59
item.wooden_hoe.name=Wooden Hoe +2 59

item.netherite_sword.name=Netherite Sword +8 2031
item.netherite_pickaxe.name=Netherite Pickaxe +6 2031
item.netherite_axe.name=Netherite Axe +7 2031
item.netherite_shovel.name=Netherite Shovel +5 2031
item.netherite_hoe.name=Netherite Hoe +6 2031

item.copper_sword.name=Copper Sword +5 191
item.copper_pickaxe.name=Copper Pickaxe +3 191
item.copper_axe.name=Copper Axe +4 191
item.copper_shovel.name=Copper Shovel +2 191
item.copper_hoe.name=Copper Hoe +3 191

item.fishing_rod.name=Fishing Rod 384
item.carrotOnAStick.name=Carrot on a Stick 26
item.warped_fungus_on_a_stick.name=Warped Fungus on a Stick 100
item.flint_and_steel.name=Flint and Steel 64
item.mace.name=Mace +5§b+§f 500
item.trident.name=Trident +8 250
item.shield.name=Shield 336
item.bow.name=Bow 384
item.crossbow.name=Crossbow 464
item.shears.name=Shears 238
item.elytra.name=Elytra 432
item.brush.name=Brush 64


## LIGHT INFO
tile.beacon.name=Beacon 15
tile.campfire.name=Campfire 15
tile.conduit.name=Conduit 15
tile.glowstone.name=Glowstone 15
tile.lit_pumpkin.name=Jack o'Lantern 15
tile.lantern.name=Lantern 15
tile.redstone_lamp.name=Redstone Lamp 15
tile.respawn_anchor.name=Respawn Anchor 3/7/11/15
tile.seaLantern.name=Sea Lantern 15
tile.sea_pickle.name=Sea Pickle 6/9/12/15
tile.shroomlight.name=Shroomlight 15
tile.end_rod.name=End Rod 14
tile.torch.name=Torch 14
tile.blast_furnace.name=Blast Furnace 13
tile.furnace.name=Furnace 13
tile.smoker.name=Smoker 13
tile.candle.name=Candle 3/6/9/12
tile.white_candle.name=White Candle 3/6/9/12
tile.orange_candle.name=Orange Candle 3/6/9/12
tile.magenta_candle.name=Magenta Candle 3/6/9/12
tile.light_blue_candle.name=Light Blue Candle 3/6/9/12
tile.yellow_candle.name=Yellow Candle 3/6/9/12
tile.lime_candle.name=Lime Candle 3/6/9/12
tile.pink_candle.name=Pink Candle 3/6/9/12
tile.gray_candle.name=Grey Candle 3/6/9/12
tile.light_gray_candle.name=Light Grey Candle 3/6/9/12
tile.cyan_candle.name=Cyan Candle 3/6/9/12
tile.purple_candle.name=Purple Candle 3/6/9/12
tile.blue_candle.name=Blue Candle 3/6/9/12
tile.brown_candle.name=Brown Candle 3/6/9/12
tile.green_candle.name=Green Candle 3/6/9/12
tile.red_candle.name=Red Candle 3/6/9/12
tile.black_candle.name=Black Candle 3/6/9/12
tile.crying_obsidian.name=Crying Obsidian 10
tile.soul_campfire.name=Soul Campfire 10
tile.soul_lantern.name=Soul Lantern 10
tile.soul_torch.name=Soul Torch 10
tile.enchanting_table.name=Enchantment Table 7
tile.enderChest.name=Ender Chest 7
tile.glow_lichen.name=Glow Lichen 7
tile.redstone_torch.name=Redstone Torch 7
tile.amethyst_cluster.name=Amethyst Cluster 5
tile.large_amethyst_bud.name=Large Amethyst Bud 4
tile.magma.name=Magma Block 3
tile.medium_amethyst_bud.name=Medium Amethyst Bud 2
tile.small_amethyst_bud.name=Small Amethyst Bud 1
item.brewing_stand.name=Brewing Stand 1
tile.brown_mushroom.name=Brown Mushroom 1
tile.dragon_egg.name=Dragon Egg 1
tile.end_portal_frame.name=End Portal Frame 1
tile.sculk_sensor.name=Sculk Sensor 1
tile.pearlescent_froglight.name=Pearlescent Froglight 15
tile.verdant_froglight.name=Verdant Froglight 15
tile.ochre_froglight.name=Ochre Froglight 15
tile.sculk_catalyst.name=Sculk Catalyst 6
tile.calibrated_sculk_sensor.name=Calibrated Sculk Sensor 1
tile.copper_bulb.name=Copper Bulb 15
tile.exposed_copper_bulb.name=Exposed Copper Bulb 12
tile.oxidized_copper_bulb.name=Oxidised Copper Bulb 8
tile.weathered_copper_bulb.name=Weathered Copper Bulb 4
tile.waxed_copper_bulb.name=Waxed Copper Bulb 15
tile.waxed_exposed_copper_bulb.name=Waxed Exposed Copper Bulb 12
tile.waxed_oxidized_copper_bulb.name=Waxed Oxidised Copper Bulb 8
tile.waxed_weathered_copper_bulb.name=Waxed Weathered Copper Bulb 4
tile.firefly_bush.name=Firefly Bush 2
tile.copper_lantern.name=Copper Lantern 15
tile.exposed_copper_lantern.name=Exposed Copper Lantern 15
tile.weathered_copper_lantern.name=Weathered Copper Lantern 15
tile.oxidized_copper_lantern.name=Oxidised Copper Lantern 15
tile.waxed_copper_lantern.name=Waxed Copper Lantern 15
tile.waxed_exposed_copper_lantern.name=Waxed Exposed Copper Lantern 15
tile.waxed_weathered_copper_lantern.name=Waxed Weathered Copper Lantern 15
tile.waxed_oxidized_copper_lantern.name=Waxed Oxidised Copper Lantern 15
tile.copper_torch.name=Copper Torch 14


## BASIC ITEM INFO

## Record Disks
item.record_11.desc=C418 - 11 1:11
item.record_13.desc=C418 - 13 2:58
item.record_blocks.desc=C418 - blocks 5:45
item.record_cat.desc=C418 - cat 3:05
item.record_chirp.desc=C418 - chirp 3:05
item.record_far.desc=C418 - far 2:54
item.record_mall.desc=C418 - mall 3:17
item.record_mellohi.desc=C418 - mellohi 1:36
item.record_stal.desc=C418 - stal 2:30
item.record_strad.desc=C418 - strad 3:08
item.record_wait.desc=C418 - wait 3:58
item.record_ward.desc=C418 - ward 4:11
item.record_pigstep.desc=Lena Raine - Pigstep 2:28
item.record_otherside.desc=Lena Raine - otherside 3:15
item.record_5.desc=Samuel Åberg - 5 2:58
item.record_relic.desc=Aaron Cherof - Relic 3:38
item.record_creator.desc=Lena Raine - Creator 2:56
item.record_creator_music_box.desc=Lena Raine - Creator (Music Box) 1:13
item.record_precipice.desc=Aaron Cherof - Precipice 4:59
item.record_tears.desc=Amos Roddy - Tears 2:55

## Spawn Eggs
item.spawn_egg.entity.agent.name=Agent Spawn Egg ∞ HP 
item.spawn_egg.entity.bee.name=Bee Spawn Egg 10 HP 
item.spawn_egg.entity.hoglin.name=Hoglin Spawn Egg 40 HP 
item.spawn_egg.entity.cat.name=Cat Spawn Egg 10 HP 
item.spawn_egg.entity.chicken.name=Chicken Spawn Egg 4 HP 
item.spawn_egg.entity.cow.name=Cow Spawn Egg 10 HP 
item.spawn_egg.entity.cod.name=Cod Spawn Egg 3 HP 
item.spawn_egg.entity.pufferfish.name=Pufferfish Spawn Egg 3 HP 
item.spawn_egg.entity.salmon.name=Salmon Spawn Egg 3 HP 
item.spawn_egg.entity.tropicalfish.name=Tropical Fish Spawn Egg 3 HP 
item.spawn_egg.entity.pig.name=Pig Spawn Egg 10 HP 
item.spawn_egg.entity.sheep.name=Sheep Spawn Egg 8 HP 
item.spawn_egg.entity.npc.name=NPC Spawn Egg ∞ HP 
item.spawn_egg.entity.wolf.name=Wolf Spawn Egg 10 HP 
item.spawn_egg.entity.villager.name=Villager Spawn Egg 20 HP 
item.spawn_egg.entity.villager_v2.name=Villager Spawn Egg 20 HP 
item.spawn_egg.entity.vindicator.name=Vindicator Spawn Egg 24 HP 
item.spawn_egg.entity.mooshroom.name=Mooshroom Spawn Egg 10 HP 
item.spawn_egg.entity.squid.name=Squid Spawn Egg 10 HP 
item.spawn_egg.entity.rabbit.name=Rabbit Spawn Egg 3 HP 
item.spawn_egg.entity.bat.name=Bat Spawn Egg 6 HP 
item.spawn_egg.entity.ravager.name=Ravager Spawn Egg 100 HP 
item.spawn_egg.entity.iron_golem.name=Iron Golem Spawn Egg 100 HP 
item.spawn_egg.entity.snow_golem.name=Snow Golem Spawn Egg 4 HP 
item.spawn_egg.entity.ocelot.name=Ocelot Spawn Egg 10 HP 
item.spawn_egg.entity.parrot.name=Parrot Spawn Egg 6 HP 
item.spawn_egg.entity.horse.name=Horse Spawn Egg 15-30 HP 
item.spawn_egg.entity.llama.name=Llama Spawn Egg 15-30 HP 
item.spawn_egg.entity.polar_bear.name=Polar Bear Spawn Egg 30 HP 
item.spawn_egg.entity.donkey.name=Donkey Spawn Egg 15-30 HP 
item.spawn_egg.entity.mule.name=Mule Spawn Egg 15-30 HP 
item.spawn_egg.entity.skeleton_horse.name=Skeleton Horse Spawn Egg 15 HP 
item.spawn_egg.entity.zombie_horse.name=Zombie Horse Spawn Egg 15 HP 
item.spawn_egg.entity.zombie.name=Zombie Spawn Egg 20 HP 
item.spawn_egg.entity.drowned.name=Drowned Spawn Egg 20 HP 
item.spawn_egg.entity.creeper.name=Creeper Spawn Egg 20 HP 
item.spawn_egg.entity.skeleton.name=Skeleton Spawn Egg 20 HP 
item.spawn_egg.entity.spider.name=Spider Spawn Egg 16 HP 
item.spawn_egg.entity.zombie_pigman.name=Zombified Piglin Spawn Egg 20 HP 
item.spawn_egg.entity.strider.name=Strider Spawn Egg 20 HP 
item.spawn_egg.entity.slime.name=Slime Spawn Egg 16/4/1 HP 
item.spawn_egg.entity.enderman.name=Enderman Spawn Egg 40 HP 
item.spawn_egg.entity.silverfish.name=Silverfish Spawn Egg 8 HP 
item.spawn_egg.entity.cave_spider.name=Cave Spider Spawn Egg 12 HP 
item.spawn_egg.entity.ghast.name=Ghast Spawn Egg 10 HP 
item.spawn_egg.entity.magma_cube.name=Magma Cube Spawn Egg 16/4/1 HP 
item.spawn_egg.entity.blaze.name=Blaze Spawn Egg 20 HP 
item.spawn_egg.entity.zombie_villager.name=Zombie Villager Spawn Egg 20 HP 
item.spawn_egg.entity.zombie_villager_v2.name=Zombie Villager Spawn Egg 20 HP 
item.spawn_egg.entity.witch.name=Witch Spawn Egg 26 HP 
item.spawn_egg.entity.stray.name=Stray Spawn Egg 20 HP 
item.spawn_egg.entity.husk.name=Husk Spawn Egg 20 HP 
item.spawn_egg.entity.wither_skeleton.name=Wither Skeleton Spawn Egg 20 HP 
item.spawn_egg.entity.guardian.name=Guardian Spawn Egg 30 HP 
item.spawn_egg.entity.elder_guardian.name=Elder Guardian Spawn Egg 80 HP 
item.spawn_egg.entity.shulker.name=Shulker Spawn Egg 30 HP 
item.spawn_egg.entity.endermite.name=Endermite Spawn Egg 8 HP 
item.spawn_egg.entity.evocation_illager.name=Evoker Spawn Egg 24 HP 
item.spawn_egg.entity.vex.name=Vex Spawn Egg 14 HP 
item.spawn_egg.entity.turtle.name=Sea Turtle Spawn Egg 30 HP 
item.spawn_egg.entity.dolphin.name=Dolphin Spawn Egg 10 HP 
item.spawn_egg.entity.phantom.name=Phantom Spawn Egg 20 HP 
item.spawn_egg.entity.panda.name=Panda Spawn Egg 20 HP
item.spawn_egg.entity.pillager.name=Pillager Spawn Egg 24 HP 
item.spawn_egg.entity.piglin_brute.name=Piglin Brute Spawn Egg 50 HP 
item.spawn_egg.entity.piglin.name=Piglin Spawn Egg 16 HP 
item.spawn_egg.entity.fox.name=Fox Spawn Egg 20 HP 
item.spawn_egg.entity.wandering_trader.name=Wandering Trader Spawn Egg 20 HP 
item.spawn_egg.entity.zoglin.name=Zoglin Spawn Egg 40 HP 
item.spawn_egg.entity.goat.name=Goat Spawn Egg 10 HP 
item.spawn_egg.entity.glow_squid.name=Glow Squid Spawn Egg 10 HP 
item.spawn_egg.entity.axolotl.name=Axolotl Spawn Egg 14 HP 
item.spawn_egg.entity.frog.name=Frog Spawn Egg 10 HP 
item.spawn_egg.entity.tadpole.name=Tadpole Spawn Egg 6 HP 
item.spawn_egg.entity.allay.name=Allay Spawn Egg 16 HP 
item.spawn_egg.entity.warden.name=Warden Spawn Egg 500 HP 
item.spawn_egg.entity.camel.name=Camel Spawn Egg 32 HP 
item.spawn_egg.entity.ender_dragon.name=Ender Dragon Spawn Egg 200 HP 
item.spawn_egg.entity.wither.name=Wither Spawn Egg 300/450/600 HP 
item.spawn_egg.entity.trader_llama.name=Trader Llama Spawn Egg 15-30 HP 
item.spawn_egg.entity.sniffer.name=Sniffer Spawn Egg 14 HP 
item.spawn_egg.entity.armadillo.name=Armadillo Spawn Egg 12 HP 
item.spawn_egg.entity.breeze.name=Breeze Spawn Egg 30 HP 
item.spawn_egg.entity.bogged.name=Bogged Spawn Egg 16 HP 
item.spawn_egg.entity.creaking.name=Creaking Spawn Egg 
item.spawn_egg.entity.happy_ghast.name=Happy Ghast Spawn Egg 20 HP 
...
item.banner.flow.black= Black Flow
item.banner.flow.blue= Blue Flow
item.banner.flow.brown= Brown Flow
item.banner.flow.cyan= Cyan Flow
item.banner.flow.gray= Grey Flow
item.banner.flow.green= Green Flow
item.banner.flow.lightBlue= Light Blue Flow
item.banner.flow.lime= Lime Flow
item.banner.flow.magenta= Magenta Flow
item.banner.flow.orange= Orange Flow
item.banner.flow.pink= Pink Flow
item.banner.flow.purple= Purple Flow
item.banner.flow.red= Red Flow
item.banner.flow.silver= Light Grey Flow
item.banner.flow.white= White Flow
item.banner.flow.yellow= Yellow Flow

item.banner.guster.black= Black Guster
item.banner.guster.blue= Blue Guster
item.banner.guster.brown= Brown Guster
item.banner.guster.cyan= Cyan Guster
item.banner.guster.gray= Grey Guster
item.banner.guster.green= Green Guster
item.banner.guster.lightBlue= Light Blue Guster
item.banner.guster.lime= Lime Guster
item.banner.guster.magenta= Magenta Guster
item.banner.guster.orange= Orange Guster
item.banner.guster.pink= Pink Guster
item.banner.guster.purple= Purple Guster
item.banner.guster.red= Red Guster
item.banner.guster.silver= Light Grey Guster
item.banner.guster.white= White Guster
item.banner.guster.yellow= Yellow Guster
